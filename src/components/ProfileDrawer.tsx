  ...
  return (
    <>
      <button
        ...
        className=" btn btn-sm btn-ghost fixed bottom-1 right-1 "
      >
        <MenuIcon />
      </button>
              ...
              <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
                ...
                >
                  <Dialog.Panel className="pointer-events-auto w-60 max-w-md">
                    <div className="flex h-full flex-col overflow-y-scroll bg-white  shadow-xl scrollbar-none bg-gradient-to-b from-blue-200 to-pink-200 relative w-full ">
                      <Menu
                        className="mt-6"
                    ...
                    <div className=" px-2 absolute top-0 w-full flex items-center justify-between">
                      <button
                        className=" btn-sm border-2  btn shadow-2xl btn-ghost text-primary"
                        onClick={() => navigate(-1)}
                      >
                        <ArrowBigLeftDashIcon />
                      </button>
                      <button
                        className="border-2  btn btn-sm shadow-2xl btn-ghost text-primary hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
