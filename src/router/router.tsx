  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        element: LazyLoad(
          import('@/views/technology/進階大師指南/1基礎強化/layout'),
        ),
        ...
        children: [
          {
            ...
            element: LazyLoad(
              import('@/views/technology/進階大師指南/1基礎強化/1this/page'),
            ),
          ...
          },
          {
            ...
            element: LazyLoad(
              import(
                '@/views/technology/進階大師指南/1基礎強化/4高頻考點/page'
              ),
            ),
          ...
          },
          {
            ...
            element: LazyLoad(
              import('@/views/technology/進階大師指南/1基礎強化/3實現api/page'),
            ),
          ...
          },
          {
            ...
            element: LazyLoad(
              import('@/views/technology/進階大師指南/1基礎強化/2closure/page'),
            ),
      ...
      },
      {
        ...
        element: LazyLoad(
          import('@/views/technology/進階大師指南/2語言進階/layout'),
        ),
        ...
        children: [
          {
            ...
            element: LazyLoad(
              import(
                '@/views/technology/進階大師指南/2語言進階/5非同步不可怕/page'
              ),
            ),
          ...
          },
          {
            ...
            element: LazyLoad(
              import(
                '@/views/technology/進階大師指南/2語言進階/6手寫Promise/page'
              ),
            ),
